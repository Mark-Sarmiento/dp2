...
const Signin = () => {
  ...
  return (
    <div className="fixed bottom-0 w-full h-screen bg-zinc-900/90 flex items-center justify-center">
      ...
      <div className="max-w-[400px] w-full mx-auto bg-white p-8">
        ...
        <div className="flex items-center justify-center px-10 py-2 relative">
